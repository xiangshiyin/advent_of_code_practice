...
while stack:
    ...
    for dr, dc in neighbors:
        ...
        if 0 <= r < n_rows and 0 <= c < n_cols and visited[r][c] == 0:
            if (lines[r][c] == "|" and r != r_curr) or (lines[r][c] == "-" and c != c_curr) or (lines[r][c] == "L" and r > r_curr) or (lines[r][c] == "J" and r > r_curr) or (lines[r][c] == "7" and r < r_curr) or (lines[r][c] == "F" and r < r_curr):
